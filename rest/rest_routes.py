...
def vote(poll_name: str, option: str):
    ...
    if poll_name and option in OPTIONS:
        try:
            ...
            return { "message" : f"Poll: {poll_name} is not OPEN or doesn't exist yet" }
        except Exception as e:
          print(f"Error {e}")
          return {"error" : f"Error {e}" }

    return { "message" : "You have to provide a valid poll_name [poll_1, poll_2, ...] and option [option_1, option_2, option_3] like /vote/poll_1/option_3"}